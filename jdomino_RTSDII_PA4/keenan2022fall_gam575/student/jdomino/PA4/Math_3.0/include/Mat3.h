...
namespace Azul
{
	...
	public:
		...
		Mat3(const Mat4& inMat4);
		//Specialized Constructor
		Mat3(Vec4 vA, Vec4 vB, Vec4 vC, Vec4 vD);
		Mat3(Vec4 vA, Vec4 vB, Vec4 vC);
		Mat3(Vec3 vA, Vec3 vB, Vec3 vC);
		...
		void set(Mat3::Row row, Vec3 inVec3);
		...
		void set(Vec3 inVec31, Vec3 inVec32, Vec3 inVec33);
