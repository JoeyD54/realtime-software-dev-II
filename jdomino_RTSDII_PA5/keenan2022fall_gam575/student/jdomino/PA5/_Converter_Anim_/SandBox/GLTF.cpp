...
bool GLTF::SetVBO(Model &gltfModel, unsigned int _AttribIndex, const char *pKey, vboData &vbo, char *pBinaryBuff, unsigned int meshIndex)
{
...
bool GLTF::SetVBO_index(Model &gltfModel, unsigned int _AttribIndex, vboData &vbo, char *pBinaryBuff, unsigned int meshIndex)
{
	// Get the accessor, buffer view
	vbo.enabled = true;
