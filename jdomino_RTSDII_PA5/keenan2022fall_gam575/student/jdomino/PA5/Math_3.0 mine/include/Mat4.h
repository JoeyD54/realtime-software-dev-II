...
namespace Azul
{
	...
	public:
		...
		Mat4 operator *=(Quat inQ);

		//Scale
		friend Mat4 operator* (float inFloat, Mat4 inMat4);
		friend Mat4 operator* (Mat4 inMat4, float inFloat);
		friend Mat4 operator* (Mat4 inMat4, Quat inQ);
		friend Mat4 operator* (Quat inQ, Mat4 inMat4);
		friend Mat4 operator/ (Mat4 inMat4, float inFloat);
		...
		//Rot Set
		void set(Mat4::Rot rot, Vec4& inVec4, float inFloat = 0.0f);
		void set(Mat4::Rot rot, Vec3 inVec3, float inFloat = 0.0f);
		...
		void set(Mat4::Orient orientType, Vec3 inVec31, Vec3 inVec32);
		...
		Mat4(Mat4::Orient orientType, Vec3 inVec31, Vec3 inVec32);
		...
		void m8(float inM8);
		void m9(float inM9);
		void m10(float inM10);
		void m11(float inM11);
		void m12(float inM12);
		void m13(float inM13);
		void m14(float inM14);
		void m15(float inM15);
