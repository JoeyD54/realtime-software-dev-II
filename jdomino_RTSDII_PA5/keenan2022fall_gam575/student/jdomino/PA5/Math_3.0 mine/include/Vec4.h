...
namespace Azul
{
	...
	public:
		...
		Vec4();
		Vec4(const Vec3& inVec3, float inFloat);
		Vec4(const Vec3& inVec3);
		...
		void set(Vec3 inVec3, float inFloat);
		...
		Vec4 operator = (const Vec3 inVec4);
		...
		friend Vec4& operator *(Vec4 inVec4, Quat inQ);
		Vec4 operator *= (Quat inQ);
