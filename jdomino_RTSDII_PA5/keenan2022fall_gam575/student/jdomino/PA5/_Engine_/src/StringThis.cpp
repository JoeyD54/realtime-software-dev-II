...
StringThis::StringThis(Texture::Name status)
{
	...
	case Texture::Name::FISH:
		strcpy_s(this->buffer, BUFFER_SIZE, STRING_ME(Mesh::FISH));
		break;

	case Texture::Name::CORSET:
		strcpy_s(this->buffer, BUFFER_SIZE, STRING_ME(Mesh::CORSET));
		break;

	case Texture::Name::OLD_CAMERA:
		strcpy_s(this->buffer, BUFFER_SIZE, STRING_ME(Mesh::OLD_CAMERA));
		break;
	case Texture::Name::OLD_TRIPOD:
		strcpy_s(this->buffer, BUFFER_SIZE, STRING_ME(Mesh::OLD_TRIPOD));
		break;
...
StringThis::StringThis(Mesh::Name status)
{
	...
	case Mesh::Name::CORSET:
		strcpy_s(this->buffer, BUFFER_SIZE, STRING_ME(Mesh::CORSET));
		break;

	case Mesh::Name::OLD_CAMERA:
		strcpy_s(this->buffer, BUFFER_SIZE, STRING_ME(Mesh::OLD_CAMERA));
		break;
	case Mesh::Name::OLD_TRIPOD:
		strcpy_s(this->buffer, BUFFER_SIZE, STRING_ME(Mesh::OLD_TRIPOD));
		break;
