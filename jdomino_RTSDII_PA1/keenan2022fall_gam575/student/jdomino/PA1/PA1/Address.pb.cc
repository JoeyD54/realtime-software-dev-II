...
PROTOBUF_CONSTEXPR Address_proto::Address_proto(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_._has_bits_)*/{}
  , /*decltype(_impl_._cached_size_)*/{}
  , /*decltype(_impl_.poname_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
  , /*decltype(_impl_.poaddr_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
  , /*decltype(_impl_.pophone_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}} {}
struct Address_protoDefaultTypeInternal {
  PROTOBUF_CONSTEXPR Address_protoDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 Address_protoDefaultTypeInternal _Address_proto_default_instance_;
...
Address_proto::Address_proto(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::MessageLite(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:Address_proto)
}
Address_proto::Address_proto(const Address_proto& from)
  : ::PROTOBUF_NAMESPACE_ID::MessageLite() {
  Address_proto* const _this = this; (void)_this;
  new (&_impl_) Impl_{
  ...
  if (from._internal_has_poname()) {
    _this->_impl_.poname_.Set(from._internal_poname(), 
  ...
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (from._internal_has_poaddr()) {
    _this->_impl_.poaddr_.Set(from._internal_poaddr(), 
      _this->GetArenaForAllocation());
  }
  ...
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (from._internal_has_pophone()) {
    _this->_impl_.pophone_.Set(from._internal_pophone(), 
      _this->GetArenaForAllocation());
  }
  // @@protoc_insertion_point(copy_constructor:Address_proto)
}

inline void Address_proto::SharedCtor(
...
const char* Address_proto::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          auto str = _internal_mutable_poname();
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          auto str = _internal_mutable_poaddr();
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
        } else
          goto handle_unusual;
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 26)) {
          auto str = _internal_mutable_pophone();
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
        } else
          goto handle_unusual;
...
uint8_t* Address_proto::_InternalSerialize(
  ...
  if (_internal_has_poname()) {
    target = stream->WriteBytesMaybeAliased(
        1, this->_internal_poname(), target);
  }

  // optional bytes poAddr = 2;
  if (_internal_has_poaddr()) {
    target = stream->WriteBytesMaybeAliased(
        2, this->_internal_poaddr(), target);
  }

  // optional bytes poPhone = 3;
  if (_internal_has_pophone()) {
    target = stream->WriteBytesMaybeAliased(
        3, this->_internal_pophone(), target);
  }
...
bool Address_proto::IsInitialized() const {
  return true;
}
...
void Address_proto::InternalSwap(Address_proto* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &_impl_.poname_, lhs_arena,
      &other->_impl_.poname_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &_impl_.poaddr_, lhs_arena,
      &other->_impl_.poaddr_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &_impl_.pophone_, lhs_arena,
...
template<> PROTOBUF_NOINLINE ::Address_proto*
Arena::CreateMaybeMessage< ::Address_proto >(Arena* arena) {
  return Arena::CreateMessageInternal< ::Address_proto >(arena);
}
