...
namespace Azul
{
	...
	void Vec3::set(float x, float y, float z, float w)
	{
		this->_vx = x;
		this->_vy = y;
		this->_vz = z;
	...
	//Vec3 * Matrix Operator Overloader
	...
	Vec3 Vec3::operator*=(Matrix inMatrix)
	{
		Vec3 newVec3;

		Vec3 v0 = inMatrix.GetV0();
		Vec3 v1 = inMatrix.GetV1();
		Vec3 v2 = inMatrix.GetV2();
		Vec3 v3 = inMatrix.GetV3();
