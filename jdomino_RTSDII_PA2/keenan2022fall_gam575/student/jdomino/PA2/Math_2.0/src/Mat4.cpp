...
namespace Azul
{
    ...
    Mat4 Mat4::getInv()
    {
        ...
        //////get cofactor of Mat4
        ////newMat4 = this->getAdjoint();
        ...
        //newMat4._m0  = (a12 * a23 * a31) - (a13 * a22 * a31) + (a13 * a21 * a32) - (a11 * a23 * a32) - (a12 * a21 * a33) + (a11 * a22 * a33);
        //newMat4._m1  = (a03 * a22 * a31) - (a02 * a23 * a31) - (a03 * a21 * a32) + (a01 * a23 * a32) + (a02 * a21 * a33) - (a01 * a22 * a33);
        //newMat4._m2  = (a02 * a13 * a31) - (a03 * a12 * a31) + (a03 * a11 * a32) - (a01 * a13 * a32) - (a02 * a11 * a33) + (a01 * a12 * a33);
        //newMat4._m3  = (a03 * a12 * a21) - (a02 * a13 * a21) - (a03 * a11 * a22) + (a01 * a13 * a22) + (a02 * a11 * a23) - (a01 * a12 * a23);
        //newMat4._m4  = (a13 * a22 * a30) - (a12 * a23 * a30) - (a13 * a20 * a32) + (a10 * a23 * a32) + (a12 * a20 * a33) - (a10 * a22 * a33);
        //newMat4._m5  = (a02 * a23 * a30) - (a03 * a22 * a30) + (a03 * a20 * a32) - (a00 * a23 * a32) - (a02 * a20 * a33) + (a00 * a22 * a33);
        //newMat4._m6  = (a03 * a12 * a30) - (a02 * a13 * a30) - (a03 * a10 * a32) + (a00 * a13 * a32) + (a02 * a10 * a33) - (a00 * a12 * a33);
        //newMat4._m7  = (a02 * a13 * a20) - (a03 * a12 * a20) + (a03 * a10 * a22) - (a00 * a13 * a22) - (a02 * a10 * a23) + (a00 * a12 * a23);
        //newMat4._m8  = (a11 * a23 * a30) - (a13 * a21 * a30) + (a13 * a20 * a31) - (a10 * a23 * a31) - (a11 * a20 * a33) + (a10 * a21 * a33);
        //newMat4._m9  = (a03 * a21 * a30) - (a01 * a23 * a30) - (a03 * a20 * a31) + (a00 * a23 * a31) + (a01 * a20 * a33) - (a00 * a21 * a33);
        //newMat4._m10 = (a01 * a13 * a30) - (a03 * a11 * a30) + (a03 * a10 * a31) - (a00 * a13 * a31) - (a01 * a10 * a33) + (a00 * a11 * a33);
        //newMat4._m11 = (a03 * a11 * a20) - (a01 * a13 * a20) - (a03 * a10 * a21) + (a00 * a13 * a21) + (a01 * a10 * a23) - (a00 * a11 * a23);
        //newMat4._m12 = (a12 * a21 * a30) - (a11 * a22 * a30) - (a12 * a20 * a31) + (a10 * a22 * a31) + (a11 * a20 * a32) - (a10 * a21 * a32);
        //newMat4._m13 = (a01 * a22 * a30) - (a02 * a21 * a30) + (a02 * a20 * a31) - (a00 * a22 * a31) - (a01 * a20 * a32) + (a00 * a21 * a32);
        //newMat4._m14 = (a02 * a11 * a30) - (a01 * a12 * a30) - (a02 * a10 * a31) + (a00 * a12 * a31) + (a01 * a10 * a32) - (a00 * a11 * a32);
        //newMat4._m15 = (a01 * a12 * a20) - (a02 * a11 * a20) + (a02 * a10 * a21) - (a00 * a12 * a21) - (a01 * a10 * a22) + (a00 * a11 * a22);
