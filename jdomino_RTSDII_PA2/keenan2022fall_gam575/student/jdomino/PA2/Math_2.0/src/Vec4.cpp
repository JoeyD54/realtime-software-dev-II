...
namespace Azul
{
	...
	float Vec4::dot(Vec4 inVec4)
	{
		...
		dotProduct = this->_vx * inVec4._vx + this->_vy * inVec4._vy + this->_vz * inVec4._vz;
	...
	Vec4 Vec4::operator*=(Mat4 inMatrix)
	{
		Vec4 newVec4;

		Vec4 v0 = inMatrix.GetV0();
		Vec4 v1 = inMatrix.GetV1();
		Vec4 v2 = inMatrix.GetV2();
		Vec4 v3 = inMatrix.GetV3();
